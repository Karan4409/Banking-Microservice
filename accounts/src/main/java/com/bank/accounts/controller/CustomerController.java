...
@Tag(
        name = "CRUD REST APIs for Customer in Banking Microservice",
        description = "CRUD REST APIs in Banking Microservice to CREATE, UPDATE, FETCH AND DELETE Banking Microservice details"
)
@RestController
@RequestMapping("/api")
@Validated
